...
- **Шаблоны веб-сайтов**: Предоставляет выбор из 5 профессиональных шаблонов (корпоративный, технологический, портфолио, платформа услуг, аналитика) или случайный выбор.
...
- **Порты**: Порт 80 (для Caddy) и 443 (для Xray) должны быть свободны.
...
Команда `template` позволяет выбрать один из следующих шаблонов:

1. **Corporate Business**: Корпоративный бизнес-сайт.
2. **Technology Company**: Сайт технологической компании.
3. **Modern Portfolio**: Портфолио для креативных профессионалов.
4. **Service Platform**: Платформа для управления сервисами.
5. **Data Analytics**: Аналитическая панель.
6. **Random Generated**: Случайный выбор шаблона.
7. **View Current Template**: Просмотреть текущий шаблон.
8. **Keep Current Template**: Сохранить текущий шаблон.

После выбора шаблона можно перезапустить Caddy для применения изменений.
