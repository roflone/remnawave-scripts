...
- **ACME SSL сертификаты**: Автоматическое получение сертификатов Let's Encrypt для Nginx
- **Автоматическая установка**: Docker-based установка с проверкой системных требований
...
| Функция | Caddy | Nginx |
|---------|-------|-------|
| SSL сертификаты | Автоматически (внутренние) | ACME (Let's Encrypt) |
